...
- (void)prepare {
    ...
    // 设置普通状态的动画图片
    [self setImages:@[UIImageWithStr(@"img_mj_stateIdle")] forState:MJRefreshStateIdle];
    
    // 设置即将刷新状态的动画图片（一松开就会刷新的状态）
    [self setImages:@[UIImageWithStr(@"img_mj_statePulling")] forState:MJRefreshStatePulling];
