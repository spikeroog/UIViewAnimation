...
- (void)configDataSource:(id)dataSource defaultSelValue:(id)defaultSelValue {
    ...
    NSArray *dataArr = nil;
    if ([dataSource isKindOfClass:[NSArray class]] && [(NSArray *)dataSource count] > 0) {
    ...
    if (self.type == BRStringPickerComponentSingle) {
        ...
        for (NSInteger i = 0; i < self.dataSourceArr.count; i++) {
            ...
            if (defaultSelValue && [defaultSelValue isKindOfClass:[NSArray class]] && [(NSArray *)defaultSelValue count] > 0 && i < [(NSArray *)defaultSelValue count] && [self.dataSourceArr[i] containsObject:defaultSelValue[i]]) {
...
- (NSInteger)pickerView:(UIPickerView *)pickerView numberOfRowsInComponent:(NSInteger)component {
    switch (self.type) {
        case BRStringPickerComponentSingle:
            ...
            break;
        case BRStringPickerComponentMore:
            return [(NSArray *)self.dataSourceArr[component] count];
            break;
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view {
    ...
    if (self.type == BRStringPickerComponentSingle) {
        ...
        label.frame = CGRectMake(0, 0, self.alertView.frame.size.width / [(NSArray *)self.dataSourceArr[component] count], 35.0f * kScaleFit);
